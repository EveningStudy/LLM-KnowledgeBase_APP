...
DEFAULT_DB_PATH = "D:/Python_Project/mylmmApp/data_base/knowledge_db"
DEFAULT_PERSIST_PATH = "D:/Python_Project/mylmmApp/database/vector_data_base"
LOGO_PATH = ""
...
with block as demo:
    with gr.Row(equal_height=True):
        with gr.Column(scale=15):
            gr.Markdown("""<h1><center>LLM应用开发</center></h1>
